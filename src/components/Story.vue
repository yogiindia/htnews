  ...
  <div class="story__container">
    <div class="story" v-if="story">
      ...
      <div class="story__score">
        <svgicon name="triangle" width="12" height="12" color="#fb8042"></svgicon>
      ...
      <div class="story__info">
        ...
        <div class="post__info">
          <svgicon name="clock" width="14" height="14" color="#fb8042" :fill="false"></svgicon>
          <span>{{ story.time | formatTimeStamp }}</span>
        </div>
        <div class="post__info">
          <svgicon name="user" width="14" height="14" color="#fb8042" :fill="false"></svgicon>
          <span>{{ story.by }}</span>
        </div>
        <div class="post__info">
          <svgicon name="comment" width="14" height="14" color="#fb8042" :fill="false"></svgicon>
